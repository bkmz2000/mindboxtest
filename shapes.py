...
будем использовать соответвующий протокол. Если нужно будет добавить новую фигуру, просто определим в ее классе это свойсто. Можно было бы использовать абстрактные классы и наследование, но простоколы мне нравятся больше.
